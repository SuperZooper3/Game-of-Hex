...
def drawHex(screen, pos, alive):
    ...
    if (pos[0] % 2 == 1):
        ...
        coords = getHexCoords(RADIUS, ((pos[0] * RADIUS) * 1.5 + OFFSET, (pos[1] * RADIUS) * 1.7 + OFFSET - hexCoordsOffset))
    else:
        coords = getHexCoords(RADIUS, ((pos[0] * RADIUS) * 1.5 + OFFSET, (pos[1] * RADIUS) * 1.7 + OFFSET))
